...
def gerar_mensagem_google(usuario):
    try:
        ...
        response = model.generate_content(
            f"Você é um professor de tecnologia. Crie uma frase curta (max 15 palavras) para {usuario['nome']} sobre a importância de estudar ciência de dados em 2026."
        )
...
for usuario in usuarios:
    ...
    usuario['news'] = msg
    print(f"✅ Gerado para {usuario['nome']}!")
    time.sleep(2)
